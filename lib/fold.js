 ...
 * @returns {{ active: boolean, course: string|null, quiz: boolean, speakEnabled: boolean, lastCourse: object|null, lastRun: object|null, gaps: Array }}
 */
export function foldTeacherState(events, end = events.length) {
  ...
  return { active, course, quiz, speakEnabled, lastCourse, lastRun, gaps }
}
